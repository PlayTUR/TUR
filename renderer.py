...
class PygameRenderer:
    ...
    def draw_lanes(self, surface, upscroll=False, pulse=0.0):
        ...
        # Base color (10, 20, 10). Pulse adds to Green component?
        # pulse is 0.0 to 1.0
        green_boost = int(30 * pulse)
        bg_col = (10, 20 + green_boost, 10)
        ...
        # Receptor Line (Pulse the thickness?)
        hit_y = int(self.ref_h * (0.15 if upscroll else 0.85))
        thick = 4 + int(2 * pulse)
        pygame.draw.line(surface, (200, 255, 200), (start_x, hit_y), (start_x + lane_w * 4, hit_y), thick)
    ...
    def draw_progress(self, surface, current, total):
        ...
        # Background
        pygame.draw.rect(surface, (20, 20, 20), (0, y, self.ref_w, h))
        # Fill
        pygame.draw.rect(surface, TERM_GREEN, (0, y, int(self.ref_w * pct), h))
